...
namespace Reptile {
	...
	Reptile::Ref<Reptile::Shader> ShaderLibrary::Load(const std::string& filepath)
	{
	...
	Reptile::Ref<Reptile::Shader> ShaderLibrary::Load(const std::string& name, const std::string& filepath)
	{
		auto shader = Shader::Create(filepath);
		Add(name, shader);
		return shader;
